      ...
      <div className="flex items-center space-x-5">
        ...
        <div className="flex flex-col items-left">
          {normalState ? (
            ...
            <>
              <h1 className="text-3xl font-bold">Change Profile Photo</h1>
              <div>
                <div className="flex flex-row">
                  ...
                  <label
                    htmlFor="file-input"
                    className={`text-white text-base md:text-md font-medium py-1 px-4 p-3 rounded bg-indigo-600 text-white hover:bg-indigo-500 w-full text-center`}
                  >
                    Choose File
                  </label>
