...
export default function Home() {
  ...
  const CONTENT = [
    ...
    "Visit the News page for real-time market insights as well as sentimental analysis by the FinBERT Natural Language Processing model (removed from prod deployment due to large slug size).",
  ...
  return (
    <main>
      <div className="flex flex-col items-center space-y-4">
          ...
          >
            ...
            <div className="flex flexrow space-x-2 justify-center">
              <Image
                ...
                height={0}
              />
              <h1 className="text-center text-5xl font-bold">PaperHans</h1>
            </div>
          </motion.div>
          <h1 className="text-base text-md font-md text-center">
        ...
        <button
          onClick={tryHomeRedirect}
          className={`${
            clickedHome ? "bg-red-600" : "bg-indigo-600"
          } text-white text-base font-medium w-[10rem] py-2 rounded shadow-[3px_3px_0_black] hover:shadow-[1px_1px_0_black] hover:translate-x-[1px] hover:translate-y-[1px] transition-all`}
        >
